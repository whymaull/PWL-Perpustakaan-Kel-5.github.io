    ...
    ?>
           <div class="container">
            ...
            <div class="leftinnerdiv">
                <br>
                <Button class="greenbtn" onclick="openpart('myaccount')"> <img class="icons" src="images/icon/profile.png" width="30px" height="30px"/> Akun Saya</Button>
                <Button class="greenbtn" onclick="openpart('requestbook')"><img class="icons" src="images/icon/book.png" width="30px" height="30px"/> Permintaan Buku   </Button>
                <Button class="greenbtn" onclick="openpart('issuereport')"> <img class="icons" src="images/icon/monitoring.png" width="30px" height="30px"/> Laporan Buku</Button>
                <a href="index.php"><Button class="greenbtn" ><img class="icons" src="images/icon/logout.png" width="30px" height="30px"/> Keluar</Button></a>
            </div>


            <div class="rightinnerdiv">   
            <div id="myaccount" class="innerright portion" style="<?php  if(!empty($_REQUEST['returnid'])){ echo "display:none";} else {echo ""; }?>">
            <Button class="greenbtn" >Akun Saya </Button>
            ...
            <p style="color:black"><u>Status Anggota:</u> &nbsp&nbsp<?php echo $type ?></p>
            ...
            <Button class="greenbtn" >Catatan Buku</Button>
            ...
            padding: 8px;'>Nama</th><th>Nama Buku</th><th>Tanggal Pinjam</th><th>Tanggal Pembalikan</th><th>Fine</th></th><th>Return</th></tr>";
            ...
            <Button class="greenbtn" >Perminataan Buku</Button>
            ...
            <th>Gambar</th><th>Nama Buku</th><th>Penulis Buku</th><th>branch</th><th>Harga</th></th><th>Permintaan Buku</th></tr>";
